  ...
  module AppStore
    module Unified
      ...
      class AppReceipt
        ...
        # The last item in in_app_receipts property order by purchase_date
        # @return [CandyCheck::AppStore::Unified::InAppReceipt]
        def latest_in_app_receipt
          in_app_receipts.sort_by(&:purchase_date).last
        end
